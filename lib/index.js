...
function readZipFileSync(path$1) {
...
function convertSpectraSync(folders, zip, options = {}) {
    ...
    for(var i = 0; i < folders.length; ++i) {
        ...
        spectra[i] = {"filename":folders[i].name,value:brukerconverter.convertFolder(brukerFiles,options)};
    }
    return spectra;
}
...
function nmredataToSampleEln(nmredata, molecule) {
